...
import { SEO, ArticleSchema, SITE_URL } from "@/components/seo";
...
export default function BlogPostPage({ slug }: { slug: string }) {
  ...
  return (
    <div>
      ...
      <ArticleSchema title={post.title} description={post.excerpt} datePublished={post.createdAt} url={`${SITE_URL}/blog/${post.slug}`} />
